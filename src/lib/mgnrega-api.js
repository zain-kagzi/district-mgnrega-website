 ...
 */
export async function fetchDistrictData(districtCode, month) {
 ...
 */
export async function fetchHistoricalData(districtCode, months = 12) {
 ...
 */
export async function getDistrictByCode(code) {
  let client;
  try {
    client = await pool.connect();
    const result = await client.query(
